...
class Tutorial6:
    def __init__(self):
        ...
        net = pysmile.Network()
        loc = self.create_cpt_node(net, "Location", "location", ["Pittsburgh", "Sahara"], 160, 360)
        rain = self.create_cpt_node(net, "Rain", "Rain", ["true", "false"], 380, 240)
        umb = self.create_cpt_node(net, "Umbrella", "Umbrella", ["true", "false"], 300, 100)
